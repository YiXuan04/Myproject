...
if($_SERVER["REQUEST_METHOD"]==="POST"){
  if(isset($_POST['submit11'])&&isset($_FILES['Upload11'])){
    $uploadOk = 1;
    $category ="filelist11";
    $target_dir="uploads/four/Rule1/filelist1/";
    ...
    if ($uploadOk) {
      ...
      // 寫入資料庫
      $stmt = $conn->prepare("INSERT INTO uploads (filename, filepath, category) VALUES (?, ?, ?)");
        if ($stmt) {
    ...
    header("Location:index.php?page=page1");  // 導向錨點
  }
  if(isset($_POST['submit12'])&&isset($_FILES['Upload12'])){
    $uploadOk = 1;
    $category ="filelist12";
    $target_dir="uploads/four/Rule1/filelist2/";
    ...
    header("Location:index.php?page=page1#$scrollTo");  // 導向錨點
  }
  if(isset($_POST['submit13'])&&isset($_FILES['Upload13'])){
    $uploadOk = 1;
    $category ="filelist13";
    $target_dir="uploads/four/Rule1/filelist3/";
  ...
  if(isset($_POST['submit14'])&&isset($_FILES['Upload14'])){
    $uploadOk = 1;
    $category ="filelist14";
    $target_dir="uploads/four/Rule1/filelist4/";
  ...
  if(isset($_POST['submit21'])&&isset($_FILES['Upload21'])){
    $uploadOk = 1;
    $category ="filelist21";
    $target_dir="uploads/four/Rule2/filelist1/";
  ...
  if(isset($_POST['submit22'])&&isset($_FILES['Upload22'])){
    $uploadOk = 1;
    $category ="filelist22";
    $target_dir="uploads/four/Rule2/filelist2/";
  ...
  if(isset($_POST['submit23'])&&isset($_FILES['Upload23'])){
    $uploadOk = 1;
    $category ="filelist23";
    $target_dir="uploads/four/Rule2/filelist3/";
  ...
  if(isset($_POST['submit24'])&&isset($_FILES['Upload24'])){
    $uploadOk = 1;
    $category ="filelist24";
    $target_dir="uploads/four/Rule2/filelist4/";
  ...
  if(isset($_POST['submit25'])&&isset($_FILES['Upload25'])){
    $uploadOk = 1;
    $category ="filelist25";
    $target_dir="uploads/four/Rule2/filelist5/";
  ...
  if(isset($_POST['submit26'])&&isset($_FILES['Upload26'])){
    $uploadOk = 1;
    $category ="filelist26";
    $target_dir="uploads/four/Rule2/filelist6/";
  ...
  if(isset($_POST['submit27'])&&isset($_FILES['Upload27'])){
    $uploadOk = 1;
    $category ="filelist27";
    $target_dir="uploads/four/Rule2/filelist7/";
    $filename = basename($_FILES["Upload27"]["name"]);
    $target_file = $target_dir . $filename;
    $FileType=strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
    $scrollTo = $_POST['scrollTo'];
    //檢查是否已存在
    ...
    if ($_FILES["Upload27"]["size"] > 100*1024*1024) {
      echo "Sorry, your file is too large.";
      $uploadOk = 0;
    }
    if ($uploadOk) {
      if (move_uploaded_file($_FILES["Upload27"]["tmp_name"], $target_file)) {
      // 寫入資料庫
      $stmt = $conn->prepare("INSERT INTO uploads (filename, filepath, category) VALUES (?, ?, ?)");
        if ($stmt) {
          $stmt->bind_param("sss", $filename, $target_file, $category);
  ...
  if(isset($_POST['submit31'])&&isset($_FILES['Upload31'])){
    $uploadOk = 1;
    $category ="filelist31";
    $target_dir="uploads/four/Rule3/filelist1/";
  ...
  if(isset($_POST['submit32108'])&&isset($_FILES['Upload32108'])){
    ...
    $target_dir="uploads/four/Rule3/filelist2/108/";
  ...
  if(isset($_POST['submit32109'])&&isset($_FILES['Upload32109'])){
    ...
    $target_dir="uploads/four/Rule3/filelist2/109/";
  ...
  if(isset($_POST['submit32110'])&&isset($_FILES['Upload32110'])){
    ...
    $target_dir="uploads/four/Rule3/filelist2/110/";
  ...
  if(isset($_POST['submit32111'])&&isset($_FILES['Upload32111'])){
    ...
    $target_dir="uploads/four/Rule3/filelist2/111/";
  ...
  if(isset($_POST['submit32112'])&&isset($_FILES['Upload32112'])){
    ...
    $target_dir="uploads/four/Rule3/filelist2/112/";
  ...
  if(isset($_POST['submit32113'])&&isset($_FILES['Upload32113'])){
    ...
    $target_dir="uploads/four/Rule3/filelist2/113/";
  ...
  if(isset($_POST['submit33108'])&&isset($_FILES['Upload33108'])){
    ...
    $target_dir="uploads/four/Rule3/filelist3/108/";
  ...
  if(isset($_POST['submit33109'])&&isset($_FILES['Upload33109'])){
    ...
    $target_dir="uploads/four/Rule3/filelist3/109/";
  ...
  if(isset($_POST['submit33110'])&&isset($_FILES['Upload33110'])){
    ...
    $target_dir="uploads/four/Rule3/filelist3/110/";
  ...
  if(isset($_POST['submit33111'])&&isset($_FILES['Upload33111'])){
    ...
    $target_dir="uploads/four/Rule3/filelist3/111/";
  ...
  if(isset($_POST['submit33112'])&&isset($_FILES['Upload33112'])){
    ...
    $target_dir="uploads/four/Rule3/filelist3/112/";
  ...
  if(isset($_POST['submit33113'])&&isset($_FILES['Upload33113'])){
    ...
    $target_dir="uploads/four/Rule3/filelist3/113/";
  ...
  if(isset($_POST['submit4101'])&&isset($_FILES['Upload4101'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/01/";
  ...
  if(isset($_POST['submit4102'])&&isset($_FILES['Upload4102'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/02/";
  ...
  if(isset($_POST['submit4103'])&&isset($_FILES['Upload4103'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/03/";
  ...
  if(isset($_POST['submit4104'])&&isset($_FILES['Upload4104'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/04/";
  ...
  if(isset($_POST['submit4105'])&&isset($_FILES['Upload4105'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/05/";
  ...
  if(isset($_POST['submit4106'])&&isset($_FILES['Upload4106'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/06/";
  ...
  if(isset($_POST['submit4107'])&&isset($_FILES['Upload4107'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/07/";
  ...
  if(isset($_POST['submit4108'])&&isset($_FILES['Upload4108'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/08/";
  ...
  if(isset($_POST['submit4109'])&&isset($_FILES['Upload4109'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/09/";
  ...
  if(isset($_POST['submit4110'])&&isset($_FILES['Upload4110'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/10/";
  ...
  if(isset($_POST['submit4111'])&&isset($_FILES['Upload4111'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/11/";
  ...
  if(isset($_POST['submit4112'])&&isset($_FILES['Upload4112'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/12/";
  ...
  if(isset($_POST['submit4113'])&&isset($_FILES['Upload4113'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/13/";
  ...
  if(isset($_POST['submit4114'])&&isset($_FILES['Upload4114'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/14/";
  ...
  if(isset($_POST['submit4115'])&&isset($_FILES['Upload4115'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/15/";
  ...
  if(isset($_POST['submit4116'])&&isset($_FILES['Upload4116'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/16/";
  ...
  if(isset($_POST['submit4117'])&&isset($_FILES['Upload4117'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/17/";
  ...
  if(isset($_POST['submit4118'])&&isset($_FILES['Upload4118'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/18/";
  ...
  if(isset($_POST['submit4119'])&&isset($_FILES['Upload4119'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/19/";
  ...
  if(isset($_POST['submit4120'])&&isset($_FILES['Upload4120'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/20/";
  ...
  if(isset($_POST['submit4121'])&&isset($_FILES['Upload4121'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/21/";
  ...
  if(isset($_POST['submit4122'])&&isset($_FILES['Upload4122'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/22/";
  ...
  if(isset($_POST['submit4123'])&&isset($_FILES['Upload4123'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/23/";
  ...
  if(isset($_POST['submit4124'])&&isset($_FILES['Upload4124'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/24/";
  ...
  if(isset($_POST['submit4125'])&&isset($_FILES['Upload4125'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/25/";
  ...
  if(isset($_POST['submit4126'])&&isset($_FILES['Upload4126'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/26/";
  ...
  if(isset($_POST['submit4127'])&&isset($_FILES['Upload4127'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/27/";
  ...
  if(isset($_POST['submit4128'])&&isset($_FILES['Upload4128'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/28/";
  ...
  if(isset($_POST['submit4129'])&&isset($_FILES['Upload4129'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/29/";
  ...
  if(isset($_POST['submit4130'])&&isset($_FILES['Upload4130'])){
    ...
    $target_dir="uploads/four/Rule4/filelist1/30/";
  ...
  if(isset($_POST['submit42108'])&&isset($_FILES['Upload42108'])){
    $uploadOk = 1;
    $category ="filelist42108";
    $target_dir="uploads/four/Rule4/filelist2/108/";
    $filename = basename($_FILES["Upload42108"]["name"]);
    $target_file = $target_dir . $filename;
    $FileType=strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
    $scrollTo = $_POST['scrollTo'];
    //檢查是否已存在
    ...
    if ($_FILES["Upload42108"]["size"] > 100*1024*1024) {
      echo "Sorry, your file is too large.";
      $uploadOk = 0;
    }
    if ($uploadOk) {
      if (move_uploaded_file($_FILES["Upload42108"]["tmp_name"], $target_file)) {
      // 寫入資料庫
      $stmt = $conn->prepare("INSERT INTO uploads (filename, filepath, category) VALUES (?, ?, ?)");
        if ($stmt) {
          $stmt->bind_param("sss", $filename, $target_file, $category);
  ...
  if(isset($_POST['submit42109'])&&isset($_FILES['Upload42109'])){
    $uploadOk = 1;
    $category ="filelist42109";
    $target_dir="uploads/four/Rule4/filelist2/109/";
    $filename = basename($_FILES["Upload42109"]["name"]);
    $target_file = $target_dir . $filename;
    $FileType=strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
    $scrollTo = $_POST['scrollTo'];
    //檢查是否已存在
    ...
    if ($_FILES["Upload42109"]["size"] > 100*1024*1024) {
      echo "Sorry, your file is too large.";
      $uploadOk = 0;
    }
    if ($uploadOk) {
      if (move_uploaded_file($_FILES["Upload42109"]["tmp_name"], $target_file)) {
      // 寫入資料庫
      $stmt = $conn->prepare("INSERT INTO uploads (filename, filepath, category) VALUES (?, ?, ?)");
        if ($stmt) {
          $stmt->bind_param("sss", $filename, $target_file, $category);
  ...
  if(isset($_POST['submit42110'])&&isset($_FILES['Upload42110'])){
    $uploadOk = 1;
    $category ="filelist42110";
    $target_dir="uploads/four/Rule4/filelist2/110/";
    $filename = basename($_FILES["Upload42110"]["name"]);
    $target_file = $target_dir . $filename;
    $FileType=strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
    $scrollTo = $_POST['scrollTo'];
    //檢查是否已存在
    ...
    if ($_FILES["Upload42110"]["size"] > 100*1024*1024) {
      echo "Sorry, your file is too large.";
      $uploadOk = 0;
    }
    if ($uploadOk) {
      if (move_uploaded_file($_FILES["Upload42110"]["tmp_name"], $target_file)) {
      // 寫入資料庫
      $stmt = $conn->prepare("INSERT INTO uploads (filename, filepath, category) VALUES (?, ?, ?)");
        if ($stmt) {
          $stmt->bind_param("sss", $filename, $target_file, $category);
  ...
  if(isset($_POST['submit42111'])&&isset($_FILES['Upload42111'])){
    $uploadOk = 1;
    $category ="filelist42111";
    $target_dir="uploads/four/Rule4/filelist2/111/";
    $filename = basename($_FILES["Upload42111"]["name"]);
    $target_file = $target_dir . $filename;
    $FileType=strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
    $scrollTo = $_POST['scrollTo'];
    //檢查是否已存在
    ...
    if ($_FILES["Upload42111"]["size"] > 100*1024*1024) {
      echo "Sorry, your file is too large.";
      $uploadOk = 0;
    }
    if ($uploadOk) {
      if (move_uploaded_file($_FILES["Upload42111"]["tmp_name"], $target_file)) {
      // 寫入資料庫
      $stmt = $conn->prepare("INSERT INTO uploads (filename, filepath, category) VALUES (?, ?, ?)");
        if ($stmt) {
          $stmt->bind_param("sss", $filename, $target_file, $category);
  ...
  if(isset($_POST['submit42112'])&&isset($_FILES['Upload42112'])){
    ...
    $target_dir="uploads/four/Rule4/filelist2/112/";
  ...
  if(isset($_POST['submit42113'])&&isset($_FILES['Upload42113'])){
    ...
    $target_dir="uploads/four/Rule4/filelist2/113/";
  ...
  if(isset($_POST['submit43108'])&&isset($_FILES['Upload43108'])){
    $uploadOk = 1;
    $category ="filelist43108";
    $target_dir="uploads/four/Rule4/filelist3/108/";
    $filename = basename($_FILES["Upload43108"]["name"]);
    $target_file = $target_dir . $filename;
    $FileType=strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
    $scrollTo = $_POST['scrollTo'];
    //檢查是否已存在
    ...
    if ($_FILES["Upload43108"]["size"] > 100*1024*1024) {
      echo "Sorry, your file is too large.";
      $uploadOk = 0;
    }
    if ($uploadOk) {
      if (move_uploaded_file($_FILES["Upload43108"]["tmp_name"], $target_file)) {
      // 寫入資料庫
      $stmt = $conn->prepare("INSERT INTO uploads (filename, filepath, category) VALUES (?, ?, ?)");
        if ($stmt) {
          $stmt->bind_param("sss", $filename, $target_file, $category);
  ...
  if(isset($_POST['submit43109'])&&isset($_FILES['Upload43109'])){
    $uploadOk = 1;
    $category ="filelist43109";
    $target_dir="uploads/four/Rule4/filelist3/109/";
    $filename = basename($_FILES["Upload43109"]["name"]);
    $target_file = $target_dir . $filename;
    $FileType=strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
    $scrollTo = $_POST['scrollTo'];
    //檢查是否已存在
    ...
    if ($_FILES["Upload43109"]["size"] > 100*1024*1024) {
      echo "Sorry, your file is too large.";
      $uploadOk = 0;
    }
    if ($uploadOk) {
      if (move_uploaded_file($_FILES["Upload43109"]["tmp_name"], $target_file)) {
      // 寫入資料庫
      $stmt = $conn->prepare("INSERT INTO uploads (filename, filepath, category) VALUES (?, ?, ?)");
        if ($stmt) {
          $stmt->bind_param("sss", $filename, $target_file, $category);
  ...
  if(isset($_POST['submit43110'])&&isset($_FILES['Upload43110'])){
    $uploadOk = 1;
    $category ="filelist43110";
    $target_dir="uploads/four/Rule4/filelist3/110/";
    $filename = basename($_FILES["Upload43110"]["name"]);
    $target_file = $target_dir . $filename;
    $FileType=strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
    $scrollTo = $_POST['scrollTo'];
    //檢查是否已存在
    ...
    if ($_FILES["Upload43110"]["size"] > 100*1024*1024) {
      echo "Sorry, your file is too large.";
      $uploadOk = 0;
    }
    if ($uploadOk) {
      if (move_uploaded_file($_FILES["Upload43110"]["tmp_name"], $target_file)) {
      // 寫入資料庫
      $stmt = $conn->prepare("INSERT INTO uploads (filename, filepath, category) VALUES (?, ?, ?)");
        if ($stmt) {
          $stmt->bind_param("sss", $filename, $target_file, $category);
  ...
  if(isset($_POST['submit43111'])&&isset($_FILES['Upload43111'])){
    $uploadOk = 1;
    $category ="filelist43111";
    $target_dir="uploads/four/Rule4/filelist3/111/";
    $filename = basename($_FILES["Upload43111"]["name"]);
    $target_file = $target_dir . $filename;
    $FileType=strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
    $scrollTo = $_POST['scrollTo'];
    //檢查是否已存在
    ...
    if ($_FILES["Upload43111"]["size"] > 100*1024*1024) {
      echo "Sorry, your file is too large.";
      $uploadOk = 0;
    }
    if ($uploadOk) {
      if (move_uploaded_file($_FILES["Upload43111"]["tmp_name"], $target_file)) {
      // 寫入資料庫
      $stmt = $conn->prepare("INSERT INTO uploads (filename, filepath, category) VALUES (?, ?, ?)");
        if ($stmt) {
          $stmt->bind_param("sss", $filename, $target_file, $category);
  ...
  if(isset($_POST['submit43112'])&&isset($_FILES['Upload43112'])){
    ...
    $target_dir="uploads/four/Rule4/filelist3/112/";
  ...
  if(isset($_POST['submit43113'])&&isset($_FILES['Upload43113'])){
    ...
    $target_dir="uploads/four/Rule4/filelist3/113/";
  ...
  if(isset($_POST['submit44'])&&isset($_FILES['Upload44'])){
    $uploadOk = 1;
    $category ="filelist44";
    $target_dir="uploads/four/Rule4/filelist4/";
  ...
  if(isset($_POST['submit45'])&&isset($_FILES['Upload45'])){
    $uploadOk = 1;
    $category ="filelist45";
    $target_dir="uploads/four/Rule4/filelist5/";
  ...
  if(isset($_POST['submit51'])&&isset($_FILES['Upload51'])){
    $uploadOk = 1;
    $category ="filelist51";
    $target_dir="uploads/four/Rule5/filelist1/";
  ...
  if(isset($_POST['submit52'])&&isset($_FILES['Upload52'])){
    $uploadOk = 1;
    $category ="filelist52";
    $target_dir="uploads/four/Rule5/filelist2/";
  ...
  if(isset($_POST['submit53'])&&isset($_FILES['Upload53'])){
    $uploadOk = 1;
    $category ="filelist53";
    $target_dir="uploads/four/Rule5/filelist3/";
  ...
  if(isset($_POST['submit54'])&&isset($_FILES['Upload54'])){
    $uploadOk = 1;
    $category ="filelist54";
    $target_dir="uploads/four/Rule5/filelist4/";
  ...
  if(isset($_POST['submit55'])&&isset($_FILES['Upload55'])){
    $uploadOk = 1;
    $category ="filelist55";
    $target_dir="uploads/four/Rule5/filelist5/";
  ...
  if(isset($_POST['submit56'])&&isset($_FILES['Upload56'])){
    $uploadOk = 1;
    $category ="filelist56";
    $target_dir="uploads/four/Rule5/filelist6/";
  ...
  if(isset($_POST['submit57'])&&isset($_FILES['Upload57'])){
    $uploadOk = 1;
    $category ="filelist57";
    $target_dir="uploads/four/Rule5/filelist7/";
  ...
  if(isset($_POST['submit58'])&&isset($_FILES['Upload58'])){
    $uploadOk = 1;
    $category ="filelist58";
    $target_dir="uploads/four/Rule5/filelist8/";
  ...
  if(isset($_POST['submit61'])&&isset($_FILES['Upload61'])){
    $uploadOk = 1;
    $category ="filelist61";
    $target_dir="uploads/four/Rule6/filelist1/";
  ...
  if(isset($_POST['submit62'])&&isset($_FILES['Upload62'])){
    $uploadOk = 1;
    $category ="filelist62";
    $target_dir="uploads/four/Rule6/filelist2/";
  ...
  if(isset($_POST['submit63'])&&isset($_FILES['Upload63'])){
    $uploadOk = 1;
    $category ="filelist63";
    $target_dir="uploads/four/Rule6/filelist3/";
  ...
  if(isset($_POST['submit64'])&&isset($_FILES['Upload64'])){
    $uploadOk = 1;
    $category ="filelist64";
    $target_dir="uploads/four/Rule6/filelist4/";
  ...
  if(isset($_POST['submit71'])&&isset($_FILES['Upload71'])){
    $uploadOk = 1;
    $category ="filelist71";
    $target_dir="uploads/four/Rule7/filelist1/";
  ...
  if(isset($_POST['submit72'])&&isset($_FILES['Upload72'])){
    $uploadOk = 1;
    $category ="filelist72";
    $target_dir="uploads/four/Rule7/filelist2/";
  ...
  if(isset($_POST['submit73'])&&isset($_FILES['Upload73'])){
    $uploadOk = 1;
    $category ="filelist73";
    $target_dir="uploads/four/Rule7/filelist3/";
  ...
  if(isset($_POST['submit74'])&&isset($_FILES['Upload74'])){
    $uploadOk = 1;
    $category ="filelist74";
    $target_dir="uploads/four/Rule7/filelist4/";
  ...
  if(isset($_POST['submit81'])&&isset($_FILES['Upload81'])){
    $uploadOk = 1;
    $category ="filelist81";
    $target_dir="uploads/four/Rule8/filelist1/";
  ...
  if(isset($_POST['submit82'])&&isset($_FILES['Upload82'])){
    $uploadOk = 1;
    $category ="filelist82";
    $target_dir="uploads/four/Rule8/filelist2/";
